...
void rememberMasterAndAddPeer(const uint8_t *mac_addr) {
  ...
  if (esp_now_add_peer(&masterPeer) == ESP_OK) {
    masterKnown = true;
    Serial.println("Master learned + peer added");
  } else {
